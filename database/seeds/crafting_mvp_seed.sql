...
VALUES
    ('medkit_basic', 'medical', 'medkit_basic', 1, NULL, 0, 'medicine', 20, 'medical_workbench', 0, TRUE),
    ('ration_pack', 'survival', 'ration_pack', 1, NULL, 0, 'survival', 10, NULL, 0, TRUE),
    ('comlink', 'utility', 'comlink', 1, NULL, 0, 'crafting', 15, 'engineering_bench', 0, TRUE)
