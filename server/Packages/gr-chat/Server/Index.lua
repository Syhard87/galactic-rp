...
local EXTERNAL_CHAT_COMMANDS = {
    ...
    allcontractlocations = true,
    deliverylocationinfo = true,
    contractlocationroutes = true,
    contractlocationhealth = true,
    unusedcontractlocations = true,
    createcontractlocation = true,
    createcontract = true,
    createdeliverycontract = true,
    createdeliverycontractat = true,
    createhaulcontract = true,
    createhaulfromroute = true,
    takejob = true,
    contractdeadline = true,
    ...
    setroutedescription = true,
    invalidroutes = true,
    setdeliverylocationhere = true,
    setcontractlocationactive = true,
    setcontractlocationradius = true,
